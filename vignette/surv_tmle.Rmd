...
```{r constant hazard}
# load mock LEADER data with simulated outcomes from a constant hazard, 
# novo.nordisk:::constant_hazard_fn. data generating process is recorded in 
# data-raw/simulate_data.R
constant_hazard <- novo.nordisk::constant_hazard
...
# Or create your own wrappers, like the following based on SL.glm. SL.misspec and
# SL.correct are respectively the misspecified and correctly specified logistic
# regressions used to generate estimator performance plots.

SL.misspec <- novo.nordisk:::simple_misspec
SL.correct <- novo.nordisk:::simple_correct
...
# load mock LEADER data with simulated outcomes from a simple constant hazard 
# and with informative censoring. The data-generating process is recorded in 
# data-raw/simulate_data.R
informative_censoring <- novo.nordisk::informative_censoring
...
SL.misspec <- novo.nordisk:::simple_misspec
SL.correct <- novo.nordisk:::correct_infcens
cens_glm <- novo.nordisk:::cens_glm
