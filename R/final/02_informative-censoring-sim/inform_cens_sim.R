...
ggsave(ic_plot, filename = "ic-data.png", device = "png",
       path = here("R/final/02_informative-censoring-sim/"),
...
stopCluster(cl)
rm(cl)
saveRDS(sim_data, file = here("R/final/02_informative-censoring-sim/inf-cens-data.RDS"))
sim_data <- read_rds(here("R/final/02_informative-censoring-sim/inf-cens-data.RDS"))
...
saveRDS(sim_estimates, here("R/final/02_informative-censoring-sim/inf-cens-estimates.RDS"))
# sim_estimates <- read_rds(here("R/final/02_informative-censoring-sim/inf-cens-estimates.RDS"))
...
saveRDS(sim_estimates, here("R/final/02_informative-censoring-sim/inf-cens-coverage.RDS"))
...
plot_df <- estimates %>%
    ...
    mutate(estimand = factor(estimand,
                             ...
                             labels = c("Control Survival", "Treated Survival",
                                        ...
                                        "Relative Survival")))
saveRDS(plot_df, here("R/final/02_informative-censoring-sim/inf-cens-plot_df.RDS"))
