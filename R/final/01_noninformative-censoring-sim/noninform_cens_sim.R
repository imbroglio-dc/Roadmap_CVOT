...
nIC_plot <- tibble(t = rep(time_span, 2),
...
ggsave(nIC_plot, filename = "nic-data.png", device = "png",
       path = here("R/final/01_noninformative-censoring-sim/"),
...
stopCluster(cl)
rm(cl)
saveRDS(sim_data, file = here("R/final/01_noninformative-censoring-sim/noninf-cens-data.RDS"))
sim_data <- read_rds(here("R/final/01_noninformative-censoring-sim/noninf-cens-data.RDS"))
...
saveRDS(sim_estimates, here("R/final/01_noninformative-censoring-sim/noninf-cens-estimates.RDS"))
# sim_estimates <- read_rds(here("R/final/01_noninformative-censoring-sim/noninf-cens-estimates.RDS"))
...
saveRDS(coverage, here("R/final/01_noninformative-censoring-sim/noninf-cens-coverage.RDS"))
...
plot_df <- estimates %>%
    ...
    mutate(estimand = factor(estimand,
                             ...
                             labels = c("Control Survival", "Treated Survival",
                                        ...
                                        "Relative Survival")))
saveRDS(plot_df, here("R/final/01_noninformative-censoring-sim/noninf-cens-plot_df.RDS"))
...
#         here("R/final/01_noninformative-censoring-sim/noninf-cens-estimates-multi.RDS"))
#
# # estimator performance ----------------------------------------------------------
#
...
#
#
# saveRDS(coverage, here("R/final/01_noninformative-censoring-sim/noninf-cens-coverage-multi.RDS"))
#
#
# # plots -------------------------------------------------------------------
#
...
#                                         "Risk Difference", "Relative Risk",
#                                         "Relative Survival")))
# saveRDS(plot_df, here("R/final/01_noninformative-censoring-sim/noninf-cens-plotdf-multi.RDS"))
#
